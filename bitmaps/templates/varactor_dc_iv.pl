...
# DC IV test template for varactors with 2 or more pins.
...
sub Usage()
{
  ...
  print "       -plus_bias []  \n";
  print "       -plus_pts []         -plus_start []          -plus_stop []               -freq_numpts []\n";

...
# DC IV test template for four-terminal pmos with LOD parameters
...
$ret = GetOptions ("h|help", "delfiles|delfiles:s", "resultfile|resultfile:s", "id_tol|id_tol:s", "abs_tol|abs_tol:s", "width|width:s", "bin_length|bin_length:s", "bin_width|bin_width:s", "length|length:s", "ad|ad:s", "pd|pd:s", "nrd|nrd:s", "ps|ps:s", "as|as:s", "nrs|nrs:s", "nqsmod|nqsmod:s", "nf|nf:i", "simulators|simulators:s", "testname|testname:s", "model_name|device_name:s", "allparams|allparams:s", "adsparams|adsparams:s", "hspiceparams|hspiceparams:s", "spectreparams|spectreparams:s", "source_v|source_v:f", "bulk_v|bulk_v:f", "gate_bias|gate_bias:f", "drain_bias|drain_bias:f", "vd_pts|vd_pts:s", "vd_start|vd_start:f", "vd_stop|vd_stop:f", "vd_numpts|vd_numpts:i", "sweep_vg|sweep_vg:s", "vg_pts|vg_pts:s", "vg_start|vg_start:f", "vg_stop|vg_stop:f", "vg_numpts|vg_numpts:i", "sweep_l|sweep_l:s", "l_pts|l_pts:s", "l_start|l_start:f", "l_stop|l_stop:f", "l_numpts|l_numpts:i", "sweep_w|sweep_w:s", "w_pts|w_pts:s", "w_start|w_start:f", "w_stop|w_stop:f", "w_numpts|w_numpts:i", "sweep_temp|sweep_temp:s", "temp_pts|temp_pts:s", "sweep_fingers|sweep_fingers:s", "fingers_pts|fingers_pts:s", "ads_model_lib|ads_model_lib:s", "hspice_model_lib|hspice_model_lib:s", "spectre_model_lib|spectre_model_lib:s","inline|inline:s", "Rgeomod|Rgeomod:s", "Geomod|Geomod:s", "Sa|Sa:s", "Sb|Sb:s", "Sd|Sd:s", "Sa1|Sa1:s", "Sb1|Sb1:s", "Sw1|Sw1:s", "Sa2|Sa2:s", "Sb2|Sb2:s", "Sw2|Sw2:s", "Sa3|Sa3:s", "Sb3|Sb3:s", "Sw3|Sw3:s", "Sa4|Sa4:s", "Sb4|Sb4:s", "Sw4|Sw4:s", "Sa5|Sa5:s", "Sb5|Sb5:s", "Sw5|Sw5:s", "Sa6|Sa6:s", "Sb6|Sb6:s", "Sw6|Sw6:s", "Sa7|Sa7:s", "Sb7|Sb7:s", "Sw7|Sw7:s", "Sa8|Sa8:s", "Sb8|Sb8:s", "Sw8|Sw8:s", "Sa9|Sa9:s", "Sb9|Sb9:s", "Sw9|Sw9:s", "Sa10|Sa10:s", "Sb10|Sb10:s", "Sw10|Sw10:s","reltol|reltol:f","vabstol|vabstol:f","iabstol|iabstol:f","gmin|gmin:f","scale|scale:f","temp|temp:f","tnom|tnom:f","digits|digits:i","ads_scale|ads_scale:f");
...
{
  if (! defined $vd_start) { $vd_start='-2.5';}
  if (! defined $vd_stop) { $vd_stop='-0.1';}
...
#  print "SWEEP_LEVEL = $sweep_level\n";
  ...
  {
    if (! defined $vg_start) { $vg_start='-1.5';}
    if (! defined $vg_stop) { $vg_stop='-0.5';}

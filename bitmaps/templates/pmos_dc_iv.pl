...
# DC IV test template for pmos with 3 or more pins.
# This template replaces pmos3_subckt_dc_iv.pl and pmos4_subckt_dc_iv.pl.
# The mverify script has been changed to accomodate for tests created for
# pmos3_subckt_dc_iv and pmos4_subckt_dc_iv.
...
# tool. It is a DC-IV Simulation using a MOSFET device.

# This simulation is intended to find Id vs Vds while sweeping Vgs.  
...
{
  if (! defined $vd_start) { $vd_start='-2.1';}

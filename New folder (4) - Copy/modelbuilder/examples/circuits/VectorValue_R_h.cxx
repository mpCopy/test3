...
#define FIX_TR                  NULL
#define VECTORVALUE_R_PARMS           VectorValue_R_parms
#define VECTORVALUE_R_ELEMENTS        VectorValue_R_elements
...
static UserElemDef VECTORVALUE_R_ELEMENTS[] =
{
  "VectorValue_R",   /* modelName */
  NUM_EXT_NODES,          /* # of external nodes */
  siz(VECTORVALUE_R_PARMS),   /* # of parameters */
  VECTORVALUE_R_PARMS,   /* # of parameter structure */
...
#include "VectorValue_R.c"


boolean boot_senior_VectorValue_R (void)
{
  return load_elements2(VECTORVALUE_R_ELEMENTS, siz(VECTORVALUE_R_ELEMENTS));
}

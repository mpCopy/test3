...
CPPFLAGS_DEBUG = 
CPPFLAGS_OPT = /DOPT_BUILD /DNDEBUG /DOPT_BUILD

PLATFORM_CCFLAGS =  /Zi /D_CRT_SECURE_NO_WARNINGS /D_CRT_NONSTDC_NO_WARNINGS  /W4  /nologo /Dfar=far_p /Dnear=near_p /Fd$(PROJECT_NAME).pdb /TC
PLATFORM_CXXFLAGS =  /Zi /D_CRT_SECURE_NO_WARNINGS /D_CRT_NONSTDC_NO_WARNINGS  /W4  /nologo /Dfar=far_p /Dnear=near_p /Fd$(PROJECT_NAME).pdb /TP
...
COMMON_SYSTEM_SHLIBS = WSock32  user32 advapi32 comdlg32 gdi32 netapi32 comctl32 winspool
...
define CCLINKEXE
$(CC_LINKPREFIX) $(LINK) /nologo  /MANIFEST $(DEBUGOPTION) $(TARGET_C_LDFLAGS) $(C_LDFLAGS) /out:$( )$(1) $(2) $(LIBLINK) $(3:%=%.lib) $(TARGET_C_LDFLAGS_POST) $(C_LDFLAGS_POST) $(COMMON_SYSTEM_LIBS:%=%.lib) $(COMMON_SYSTEM_SHLIBS:%=%.lib)

endef

define CXXLINKEXE
$(CXX_LINKPREFIX) $(LINK) /nologo  /MANIFEST $(DEBUGOPTION) $(TARGET_CXX_LDFLAGS) $(CXX_LDFLAGS) /out:$( )$(1) $(2) $(LIBLINK) $(3:%=%.lib) $(TARGET_CXX_LDFLAGS_POST) $(CXX_LDFLAGS_POST) $(COMMON_SYSTEM_LIBS:%=%.lib) $(COMMON_SYSTEM_SHLIBS:%=%.lib)

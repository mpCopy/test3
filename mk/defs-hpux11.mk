...
CPPFLAGS =  -D_HPUX_SOURCE -DSYSV -DHPUX_11 
CPPFLAGS_DEBUG = 
CPPFLAGS_OPT = -DOPT_BUILD -DNDEBUG

PLATFORM_CCFLAGS = -Ae -z +Z +DS871 +w1
PLATFORM_CXXFLAGS =  -z +Z +DS871 +w
...
SHLIBPATHVAR = SHLIB_PATH
SYSTEMSHLIBPATH = 

LINK.csl = $(CC) -b $(SLFLAGS)
LINK.cxxsl = aCC -b -lCsup_v2 $(SLFLAGS)

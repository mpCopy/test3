...
PLATFORM_CCFLAGS =  -fPIC -pipe -D__USE_XOPEN2K8  
PLATFORM_CXXFLAGS =  -fPIC -std=c++11 -pipe -D__USE_XOPEN2K8  
...
CFLAGS_DEBUG = -D_DEBUG -DDEBUG
CFLAGS_OPT = -O2 -DNDEBUG -DOPT_BUILD
CFLAGS_OPT_LESSER = -O1 -DNDEBUG -DOPT_BUILD

CXXFLAGS = $(LOCAL_BUILD_CXXFLAGS) $(TARGET_CXXFLAGS) $(ADDITIONAL_BUILD_CXXFLAGS) $(PLATFORM_CXXFLAGS)
CXXFLAGS_DEBUG = -D_DEBUG -DDEBUG
CXXFLAGS_OPT = -O2 -DNDEBUG
CXXFLAGS_OPT_LESSER = -O1 -DNDEBUG
...
LINK.csl = $(CC) -shared $(SLFLAGS)
LINK.cxxsl = $(CXX) -shared $(SLFLAGS)

<ADSWorkspace Revision="1" Version="100">
    <Workspace Name="">
        ...
        <Library Name="pdk_amg_lib" />
        <Cell Name="pdk_amg_lib:cell_1" />
        <Cell Name="pdk_amg_lib:cell_2" />
        <Cell Name="pdk_amg_lib:cell_3" />
        <Cell Name="pdk_amg_lib:cell_4" />
        <Cell Name="pdk_amg_lib:cell_5" />

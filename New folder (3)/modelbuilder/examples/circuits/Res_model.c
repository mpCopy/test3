...
LOCAL const char sccs_cui_circuit_template[]="@(#) $Source: /cvs/sr/src/geminiui/modelbuilder/Res_model.c,v $ $Revision: 1.4 $ $Date: 2011/08/27 00:17:20 $";
...
/*****************************************************************************
   This model is used as a model card. It defines model parameters. Other
   UCM device instance references to the model by the model name, and reads
   parameter values from the model.
   Since this model only defines parameters, not behaviors, there is no need 
   to fill in any implementation in device loading function listed below.
*******************************************************************************/

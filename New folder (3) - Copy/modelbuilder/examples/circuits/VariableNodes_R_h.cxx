...
#define FIX_TR                  NULL
#define VARIABLENODES_R_PARMS           VariableNodes_R_parms
#define VARIABLENODES_R_ELEMENTS        VariableNodes_R_elements
...
VariableNodes_R_parms[] =
{
    {"NumExtNodes", INT_data},   {"Res", REAL_data}
};



static UserElemDef VARIABLENODES_R_ELEMENTS[] =
{
  "VariableNodes_R",   /* modelName */
  NUM_EXT_NODES,          /* # of external nodes */
  siz(VARIABLENODES_R_PARMS),   /* # of parameters */
  VARIABLENODES_R_PARMS,   /* # of parameter structure */
...
#include "VariableNodes_R.c"


boolean boot_senior_VariableNodes_R (void)
{
  return load_elements2(VARIABLENODES_R_ELEMENTS, siz(VARIABLENODES_R_ELEMENTS));
}

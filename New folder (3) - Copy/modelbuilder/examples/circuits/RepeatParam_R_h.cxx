...
#define FIX_TR                  NULL
#define REPEATPARAM_R_PARMS           RepeatParam_R_parms
#define REPEATPARAM_R_ELEMENTS        RepeatParam_R_elements
...
static UserElemDef REPEATPARAM_R_ELEMENTS[] =
{
  "RepeatParam_R",   /* modelName */
  NUM_EXT_NODES,          /* # of external nodes */
  siz(REPEATPARAM_R_PARMS),   /* # of parameters */
  REPEATPARAM_R_PARMS,   /* # of parameter structure */
...
#include "RepeatParam_R.c"


boolean boot_senior_RepeatParam_R (void)
{
  return load_elements2(REPEATPARAM_R_ELEMENTS, siz(REPEATPARAM_R_ELEMENTS));
}

...
#include <math.h>
/**************************************************************************
 * Modification Notice -- Include stdlib.h
 * -------------------------------------------------
 ...
 */
   ...
   {
/**************************************************************************
 * Modification Notice -- Duplication
 * -------------------------------------------------
 * This code has been modified by Keysight Technologies, January 2009,
 * but WITHOUT ANY WARRANTY; without even the implied warranty of 
 * MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE.
...
/**************************************************************************
 * Modification Notice -- Force to have at least one grid point
 * -------------------------------------------------
 * This code has been modified by Keysight Technologies, January 2009,
 * but WITHOUT ANY WARRANTY; without even the implied warranty of 
 * MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE.
...
/**************************************************************************
 * Modification Notice -- Allocate sufficient memory size
 * -------------------------------------------------
 * This code has been changed by Keysight Technologies, January 2009,
 * but WITHOUT ANY WARRANTY; without even the implied warranty of 
 * MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE.
 *
 *************************************************************************/
 ...
 */
   ...
   //}
/**************************************************************************
 * Modification Notice -- Prevent out of bound access
 * -------------------------------------------------
 * This code has been changed by Keysight Technologies, January 2009,
 * but WITHOUT ANY WARRANTY; without even the implied warranty of 
 * MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE.
...
/**************************************************************************
 * Modification Notice -- Change return type to int
 * -------------------------------------------------
 * This code has been modified by Keysight Technologies, January 2009,
 * but WITHOUT ANY WARRANTY; without even the implied warranty of 
 * MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE.
...
/**************************************************************************
 * Modification Notice -- Force each band to have at least one grid point
 * -------------------------------------------------
 * This code has been modified by Keysight Technologies, January 2009,
 * but WITHOUT ANY WARRANTY; without even the implied warranty of 
 * MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE.
 *
 *************************************************************************/
	  int bandsize = (int)(2*r*GRIDDENSITY*(bands[2*i+1] - bands[2*i]) + .5);
	  gridsize += (bandsize >= 1 ? bandsize : 1);
   }
   if (symmetry == NEGATIVE)
   {
      gridsize--;
 ...
 */
   ...
   //}
/**************************************************************************
 * Modification Notice -- Comment out printf
 * -------------------------------------------------
 * This code has been modified by Keysight Technologies, January 2009,
 * but WITHOUT ANY WARRANTY; without even the implied warranty of 
 * MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE.
...
/**************************************************************************
 * Modification Notice -- Return convergence result
 * -------------------------------------------------
 * This code has been modified by Keysight Technologies, January 2009,
 * but WITHOUT ANY WARRANTY; without even the implied warranty of 
 * MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE.
